...
public class SemCoisas implements Listener
{
    ...
    public void onReload(final PlayerCommandPreprocessEvent event) {
        ...
        if ((msg.equalsIgnoreCase("/rl") || msg.equalsIgnoreCase("/reload")) && p.isOp() && p.hasPermission("style.reload")) {
    ...
    public void noFMessage(final PlayerDeathEvent event) {
        ...
        event.getEntity().getPlayer().getWorld().playSound(event.getEntity().getPlayer().getLocation(), Sound.ANVIL_LAND, 1.0f, 1.0f);
