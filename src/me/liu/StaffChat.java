		...
		if (commandLabel.equalsIgnoreCase("s")) {
			...
			if (player.hasPermission(new Permissions().StaffChat)) {
				if (args.length == 0) {
					...
					for (int length4 = (onlinePlayers4 = Bukkit.getServer().getOnlinePlayers()).length,
							l = 0; l < length4; ++l) {
					...
					for (int length6 = (onlinePlayers6 = Bukkit.getServer().getOnlinePlayers()).length,
							n2 = 0; n2 < length6; ++n2) {
					...
					for (int length7 = (onlinePlayers7 = Bukkit.getServer().getOnlinePlayers()).length,
							n3 = 0; n3 < length7; ++n3) {
					...
					for (int length8 = (onlinePlayers8 = Bukkit.getServer().getOnlinePlayers()).length,
							n4 = 0; n4 < length8; ++n4) {
					...
					for (int length9 = (onlinePlayers9 = Bukkit.getServer().getOnlinePlayers()).length,
							n5 = 0; n5 < length9; ++n5) {
					...
					for (int length10 = (onlinePlayers10 = Bukkit.getServer().getOnlinePlayers()).length,
							n6 = 0; n6 < length10; ++n6) {
					...
					for (int length11 = (onlinePlayers11 = Bukkit.getServer().getOnlinePlayers()).length,
							n7 = 0; n7 < length11; ++n7) {
					...
					for (int length12 = (onlinePlayers12 = Bukkit.getServer().getOnlinePlayers()).length,
							n8 = 0; n8 < length12; ++n8) {
					...
					for (int length13 = (onlinePlayers13 = Bukkit.getServer().getOnlinePlayers()).length,
							n9 = 0; n9 < length13; ++n9) {
					...
					for (int length14 = (onlinePlayers14 = Bukkit.getServer().getOnlinePlayers()).length,
					...
					for (int length15 = (onlinePlayers15 = Bukkit.getServer().getOnlinePlayers()).length,
					...
					for (int length16 = (onlinePlayers16 = Bukkit.getServer().getOnlinePlayers()).length,
