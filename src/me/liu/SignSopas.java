...
public class SignSopas implements Listener
{
    ...
    public void SignClickEvent111(final PlayerInteractEvent e) {
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK && (e.getClickedBlock().getType() == Material.SIGN || e.getClickedBlock().getType() == Material.SIGN_POST || e.getClickedBlock().getType() == Material.WALL_SIGN)) {
            ...
            if (sign.getLine(0).equalsIgnoreCase("§6[§4Gratis§6]") && sign.getLine(1).equalsIgnoreCase("§1CoguVermelho")) {
    ...
    public void SignClickEvent11(final PlayerInteractEvent e) {
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK && (e.getClickedBlock().getType() == Material.SIGN || e.getClickedBlock().getType() == Material.SIGN_POST || e.getClickedBlock().getType() == Material.WALL_SIGN)) {
            final Sign sign = (Sign)e.getClickedBlock().getState();
            if (sign.getLine(0).equalsIgnoreCase("§6[§4Gratis§6]") && sign.getLine(1).equalsIgnoreCase("§1CoguMarrom")) {
        ...
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK && (e.getClickedBlock().getType() == Material.SIGN || e.getClickedBlock().getType() == Material.SIGN_POST || e.getClickedBlock().getType() == Material.WALL_SIGN)) {
            ...
            if (sign.getLine(1).equalsIgnoreCase("§6/main")) {
                if (!Main.used.contains(e.getPlayer().getName())) {
                    ...
                    e.getPlayer().sendMessage(ChatColor.RED + "Voce ja escolheu um kit. Digite /suicide para ir a Main.");
                }
            }
        }
    }
