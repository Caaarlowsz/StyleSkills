...
public class ArmorIncre implements Listener
{
    ...
    public void semQuebrar(final EntityDamageByEntityEvent event) {
        if (event.getEntity() instanceof Player && event.getDamager() instanceof Player) {
            ...
            if (p.getItemInHand().getType().equals((Object)Material.WOOD_SWORD) || p.getItemInHand().getType().equals((Object)Material.STONE_SWORD) || p.getItemInHand().getType().equals((Object)Material.GOLD_SWORD) || p.getItemInHand().getType().equals((Object)Material.IRON_SWORD) || p.getItemInHand().getType().equals((Object)Material.DIAMOND_SWORD) || p.getItemInHand().getType().equals((Object)Material.STONE_AXE) || p.getItemInHand().getType().equals((Object)Material.WOOD_AXE) || p.getItemInHand().getType().equals((Object)Material.GOLD_AXE) || p.getItemInHand().getType().equals((Object)Material.FISHING_ROD)) {
