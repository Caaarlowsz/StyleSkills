...
public class Bomber implements Listener, CommandExecutor
{
    ...
    public void eventBomber(final PlayerInteractEvent e) {
        ...
        if (p.getItemInHand().getType() == Material.TNT && Main.bomber.contains(p.getName()) && (e.getAction().equals((Object)Action.RIGHT_CLICK_AIR) || e.getAction().equals((Object)Action.RIGHT_CLICK_BLOCK))) {
            if (this.hasCooldown()) {
