...
public class CommandKit implements CommandExecutor {
	...
	public boolean onCommand(final CommandSender sender, final Command cmd, final String commandLabel,
		...
		if (commandLabel.equalsIgnoreCase("kit") || commandLabel.equalsIgnoreCase("kits")) {
			...
			final String[] Kits = { "PvP", "Archer", "Kangaroo", "Fisherman", "Backpacker", "Timelord", "Snail",
					"Frosty", "Tank", "Viper", "Rider", "Milkman", "Cultivator", "Specialist", "Stomper", "Poseidon",
					"CookieMonster", "Viking", "Vampire", "Hulk", "Berserker", "Monk", "Camel", "Anchor", "Switcher",
					"Grappler", "Turtle", "Flash", "Thor", "Snowman", "Healer", "Sonic", "Neo", "Phantom", "Endermage",
					"Urgal", "Lifeline", "Gambler", "Darkmage", "Spectre", "Zombie", "Salamander", "Reaper", "Chemist",
					"Pyro", "Macaco" };
			String[] array;
			...
			if (free.length() == 0) {
				player.sendMessage(
						ChatColor.DARK_GREEN + "Seus Kits : " + ChatColor.WHITE + "Voce nao tem nenhum kit!");
			} else {
