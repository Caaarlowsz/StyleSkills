		...
		if (cmd.getName().equalsIgnoreCase("tag")) {
			if (args.length > 0 && (p.hasPermission("tag.op") || p.isOp())) {
				if (args[0].toLowerCase().equals("normal")) {
					...
					p.sendMessage(
							"§2Use: (§7Normal §2| §a§oVip §2| §6§oEterno §2| §b§oYoutuber §2| §5Mod §2| §5§oMod+ §2| §3§oBuilder §2| §c Admin §2| §c§oOrganizador §2| §4§oDono§2|)");
				}
				...
				if (args[0].toLowerCase().equals("normal")) {
					...
					p.sendMessage(
							"§2Use: (§7Normal §2|§a§o Vip §2|§6§o Eterno §2|§b§o Youtuber §2| §5Mod §2| §5§o Mod+ §2|)");
				}
				...
				if (args[0].toLowerCase().equals("normal")) {
					...
					p.sendMessage(
							"§2Use: (§7Normal §2| §a§oVip §2| §6§oEterno §2| §b§oYoutuber §2|§5§o Mod §2|§c Admin §2|)");
				}
				...
				if (args[0].toLowerCase().equals("normal")) {
					...
					p.sendMessage(
							"§2Use: (§7Normal §2| §a§oVip §2| §6§oEterno §2| §b§oYoutuber §2|§5§o Mod §2|§c Admin §2| §c§oOrganizador §2|)");
				}
