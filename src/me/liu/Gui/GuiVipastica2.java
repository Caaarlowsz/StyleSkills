...
public class GuiVipastica2 implements CommandExecutor, Listener
{
    ...
    public boolean onCommand(final CommandSender sender, final Command cmd, final String commandLabel, final String[] args) {
        ...
        if (commandLabel.equalsIgnoreCase("kits") || commandLabel.equalsIgnoreCase("kit") || (commandLabel.equalsIgnoreCase("kitvip2") && p.hasPermission("kitmenu.vip"))) {
            ...
            vacuuml.add("§7-*-*-*-*-*-*-*-*-*-*");
            vacuumm.setLore((List)launcherl);
